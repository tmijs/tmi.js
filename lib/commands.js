...
module.exports = {
    ...
    host: function host(channel, target) {
        ...
        return this._sendCommand(1500, channel, `/host ${target}`, (resolve, reject) => {
            this.once("_promiseHost", (err) => {
                if (!err) { resolve([channel, target]); }
                else { reject(err); }
            });
        });
    },
    ...
    unhost: function unhost(channel) {
        ...
        return this._sendCommand(1200, channel, "/unhost", (resolve, reject) => {
