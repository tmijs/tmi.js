...
module.exports = {
	...
	color: function color(newColor) {
		// Send the command to the server and race the Promise against a delay..
		return this._sendCommand(this._getPromiseDelay(), this.username, `/color ${newColor}`, (resolve, reject) => {
	...
	whisper: function whisper(username, message) {
		...
		// Send the command to the server and race the Promise against a delay..
		return this._sendCommand(this._getPromiseDelay(), this.username, `/w ${username} ${message}`, (resolve, reject) => {
