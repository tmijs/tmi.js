            ...
            switch(message.command) {
                ...
                case "NOTICE":
                    switch(msgid) {
                        ...
                        case "delete_message_success":
                            this.log.info(`[${channel} ${msg}]`);
                            this.emits(["notice", "_promiseDeletemessage"], [[channel, msgid, msg], [null]]);
                        ...
                        case "bad_delete_message_mod":
                            this.log.info(`[${channel}] ${msg}`);
                            this.emits(["notice", "_promiseDeletemessage"], [[channel, msgid, msg], [msgid]]);
                            break;
                ...
                case "USERNOTICE":
                    ...
                    // Handle anonymous gift sub
                        ...
                        var userstate = message.tags;
                        userstate["message-type"] = "anonsubgift";
                    ...
                    // Handle random gift subs
                        ...
                        var userstate = message.tags;
                        userstate["message-type"] = "submysterygift";
                    ...
                    // Handle anonymous random gift subs
                        ...
                        var userstate = message.tags;
                        userstate["message-type"] = "anonsubmysterygift";
                    ...
                    // Handle user upgrading from a gifted sub
                        ...
                        var username = message.tags["display-name"] || message.tags["login"];
                        var sender = message.tags.get("msg-param-sender-name") || message.tags.get("msg-param-sender-login");
                    ...
                    // Handle user upgrading from an anonymous gifted sub
                        ...
                        var userstate = message.tags;
                        userstate["message-type"] = "anongiftpaidupgrade";
