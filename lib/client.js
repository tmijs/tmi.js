...
client.prototype.isMod = _.deprecate(function isMod(channel, username) {
    ...
    return false;
}, 'client#isMod is not the recommended way to get a moderator status.\nThis method will be removed in an upcoming release.\nSee https://github.com/Schmoopiie/tmi.js/issues/118 for more details.');
