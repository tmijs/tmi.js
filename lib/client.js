        ...
        switch(message.command) {
            ...
            case "NOTICE":
                ...
                switch(msgid) {
                    ...
                    case "usage_color":
                        // @msg-id=usage_color :tmi.twitch.tv NOTICE #blue :Usage: "/color <color>" - Change your username color. Color must be in hex (#000000) or one of the following: Blue, BlueViolet, CadetBlue, Chocolate, Coral, DodgerBlue, Firebrick, GoldenRod, Green, HotPink, OrangeRed, Red, SeaGreen, SpringGreen, YellowGreen.
                        break;

                    // Implement this later.
                    case "color_changed":
                        // :tmi.twitch.tv NOTICE #efficiencyvi :Your color has been changed.
                        break;
