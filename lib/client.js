	...
	// Messages with "tmi.twitch.tv" as a prefix..
		...
		switch(message.command) {
			...
			case "USERNOTICE":
				...
				var giftMonthCount = ~~(message.tags["msg-params-gift-months"] || 0);
				...
				switch(msgid) {
					...
					// Handle gift sub
					case "subgift":
						this.emit("subgift", channel, username, giftMonthCount, recipient, methods, userstate);
						break;

					// Handle anonymous gift sub
					// Need proof that this event occur
					case "anonsubgift":
						this.emit("anonsubgift", channel, giftMonthCount, recipient, methods, userstate);
						break;
