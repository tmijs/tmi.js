		...
		switch(message.command) {
			...
			case "USERNOTICE":
				...
				switch(msgid) {
					...
					case "ritual":
						var ritualName = userstate["msg-param-ritual-name"];
						switch(ritualName) {
							case "new_chatter":
								this.emit("newchatter", channel, username, userstate, msg);
								break;
							default: 
								this.emit("ritual", ritualName, channel, username, userstate, msg);
								break;
						}
						break;
					default:
						this.emit("usernotice", msgid, channel, userstate, msg);
						break;
				}
